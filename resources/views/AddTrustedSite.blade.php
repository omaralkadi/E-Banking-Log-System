...
<h1 class="display-6">Sites:</h1></br>
</div>
<div class="d-flex justify-content-center">
<p>In this section the user can check any website link to verify if it belongs to our bank or not.</p>
</div>
...
@foreach($sites as $s)
    <li class="list-group-item" >{{$s->Site}} <a href="Site/{{$s->id}}/remove" style="float:right">Remove</a> 
     <a href="Site/{{$s->id}}/edite" style="float:right;margin-right:10px;">edite</a></li>  
